...
[_COLEMAK] = LAYOUT_ortho_4x12(
    ...
    KC_LCTL, KC_LGUI, KC_LALT, KC_LSFT, KC_SPC, LOWER, RAISE, KC_RSFT, KC_BSPC, KC_MINS, KC_EQL,  KC_RGHT
),
...
[_LOWER] = LAYOUT_ortho_4x12(
    _______, xxxxxxx,  KC_LCBR, KC_RCBR, xxxxxxx,  xxxxxxx, KC_TILD, KC_7,    KC_8,    KC_9,    KC_0,    _______,
...
[_RAISE] = LAYOUT_ortho_4x12(
    _______, xxxxxxx,  KC_LCBR, KC_RCBR, xxxxxxx,  xxxxxxx, xxxxxxx, KC_PGUP, KC_UP,   KC_PGDN, _______, ________,
    _______, xxxxxxx,  KC_LPRN, KC_RPRN, xxxxxxx,  xxxxxxx, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_DEL , ________,
    _______, xxxxxxx,  KC_LBRC, KC_RBRC, xxxxxxx,  xxxxxxx, KC_SLSH, KC_1,    KC_2,    KC_3,    xxxxxxx, xxxxxxxx,
...
[_FN] = LAYOUT_ortho_4x12(
    ...
    _______, xxxxxxx, KC_VOLU, KC_VOLD, KC_MUTE, xxxxxxx, xxxxxxx, KC_F4,   KC_F5,   KC_F6,   KC_F11,  _______,
